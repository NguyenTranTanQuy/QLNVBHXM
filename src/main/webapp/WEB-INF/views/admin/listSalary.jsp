	...
	<div class="table-wrap">
		<table class="table" id="table-salary">
			...
			<c:forEach var="o" items="${listSalary}">
				<tr class="table-row">
					<td class="table-data">${o.manvluong.manv}</td>
					<td class="table-data">${o.manvluong.ho}</td>
					<td class="table-data">${o.manvluong.ten}</td>
					...
					<td class="table-data currency">${tienphat.get(o.manvluong.manv)}</tb>
